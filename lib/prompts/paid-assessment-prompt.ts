...
1. **🎯 Your Exact Market Position Right Now**
...
2. **🔬 Forensic Skill Gap Analysis for [Target Role]**
...
3. **📚 [University] Advantage Exploitation Strategy**
...
4. **🗓️ Your Personal 90-Day Transformation Plan**
...
5. **💼 Three Portfolio Projects That Get You Hired**
...
6. **🤖 AI-Augmented Learning for [Learning Style]**
...
7. **🔗 Strategic Networking (Without Being Cringe)**
...
8. **💰 Salary Intelligence for [Target Role] from [University]**
   <compensation_data>
...
9. **📝 Interview Domination Playbook**
   <behavioral_prep>
...
11. **📊 Weekly Success Metrics Dashboard**
...
12. **🔄 Contingency Plans for Your Situation**
    <if_scenarios>
...
💡 Counterintuitive insight: [Something surprising about their path]
⚡ Unfair advantage you have: [Unique positioning opportunity]
⏰ Time-sensitive opportunity: [Something available only now]
🎯 One weird trick that works: [Unconventional but effective strategy]
</unique_insights>
...
export function getPaidAssessmentPrompt(input: {
  major: string;
  university: string;
  targetRole: string;
...
<months_to_graduation>${input.monthsToGraduation}</months_to_graduation>
</Inputs>
